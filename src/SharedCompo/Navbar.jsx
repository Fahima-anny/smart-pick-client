...
<Link to='/signUp' className="text-xl font-semibold  gap-1 items-center hover:text-black duration-500 hidden md:flex"><FaUserLock />Sign up</Link>
     ...
     <div className="navbar-start">
          ...
          <a data-aos="fade-right"  className="font-bold text-4xl font-serif flex items-center"><img src={logo} className="w-[35px] h-[35px] mr-1"></img>Smart<span className="text-blue-500">Pick</span></a>
        </div>
